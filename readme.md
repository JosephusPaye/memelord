...
| `/award`       | <code>/award&nbsp;<@firstA>[,<@firstB>,<@firstC>]<br>&nbsp;&nbsp;[@secondA],[@secondB],[@secondC]<br>&nbsp;&nbsp;[@thirdA],[@thirdB],[@thirdC]</code> | Award one or more users as winner, with multiple users for first, second, and third place each.                                                                                                                                                                                                                                                                              |
